...
namespace com.ximpleware
{
    ...
    public class VTDNav
    {
        ...
        private long getChar4OtherEncoding(long offset)
        {
        ...
        /// </exception>
        private long getChar(long offset)
        {
            long temp = 0;
        ...
        /// </exception>
        private long getCharResolved(long offset)
        {
            int ch = 0;
            int val = 0;
            long inc = 2;
        ...
        private long handle_utf8(long temp, long offset)
        {
            int a, d, c;
            long val;
        ...
        private long handle_utf16le(long offset)
        {
        ...
        private const long MASK_TOKEN_TYPE = unchecked((long)0xf000000000000000);
        //UPGRADE_TODO: Literal detected as an unsigned long can generate compilation errors. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1175'"
        private const long MASK_TOKEN_DEPTH = 0x0fc0000000000000L;
        ...
        /// </param>
        protected internal VTDNav(int RootIndex, int enc, bool NS, int depth, IByteBuffer x, ILongBuffer vtd, ILongBuffer l1, ILongBuffer l2, IIntBuffer l3, long so, long length)
        {
        ...
        public int getTokenLength(int index)
        {
            ...
            switch (type)
            {
                ...
                default:
                    return (int)((vtdBuffer.longAt(index) & MASK_TOKEN_FULL_LEN) >> 37);
        ...
        /// <exception cref="">
        /// </exception>
        public long getTokenOffset(int index)
        {
            //return (context[0] != 0)
        ...
        public bool matchElementNS(System.String URL, System.String ln)
        {
            ...
            long offset = getTokenOffset((context[0] != 0) ? context[context[0]] : rootIndex);
            int preLen = (i >> 16) & 0xffff;
            int fullLen = i & 0xffff;
        ...
        private bool matchRawTokenString(long offset, int len, System.String s)
        {
        ...
        /// <exception cref="IllegalArguementException">if s is null
        /// </exception>
        private bool matchTokenString(long offset, int len, System.String s)
        {
        ...
        /// <param name="len"></param>
        /// <returns></returns>
        protected internal int lookupNS(long offset, int len)
        {
            long l;
            bool hasNS = false;
            int size = vtdBuffer.size();
        ...
        /// <exception cref="com.ximpleware.NavException">When there is any encoding conversion error or unknown entity.
        /// </exception>
        private bool resolveNS(System.String URL, long offset, int len)
        {
        ...
        protected internal System.String toRawString(long os, int len)
        {
            long endOffset = len + os;
            long offset = os;
            long l;
            System.Text.StringBuilder sb = new System.Text.StringBuilder(len);
        ...
        protected internal System.String toString(long os, int len)
        {
            long endOffset = len + os;
            long offset = os;
            System.Text.StringBuilder sb = new System.Text.StringBuilder(len);
        ...
        /// <param name="s"></param>
        /// <returns></returns>
        protected internal int compareTokenString(long offset, int len, String s)
        {
            int i, l;
            long l1;
        ...
        /// <param name="s"></param>
        /// <returns></returns>
        protected internal int compareRawTokenString(long offset, int len, String s)
        {
            int i, l;
            long l1;
            //this.currentOffset = offset;
