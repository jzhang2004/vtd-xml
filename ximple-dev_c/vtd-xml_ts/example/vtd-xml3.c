...
int main(void){
  pthread_t mythread, mythread2, mythread3, mythread4, mythread5, mythread6;
  ...
  if ( pthread_create( &mythread, NULL, thread_function, NULL) ) {
   ...
   if ( pthread_create( &mythread3, NULL, thread_function, NULL) ) {
    printf("error creating thread2.");
    abort();
  }
   if ( pthread_create( &mythread4, NULL, thread_function, NULL) ) {
    printf("error creating thread2.");
    abort();
  }
   if ( pthread_create( &mythread5, NULL, thread_function, NULL) ) {
    printf("error creating thread2.");
    abort();
  }
   if ( pthread_create( &mythread6, NULL, thread_function, NULL) ) {
    printf("error creating thread2.");
    abort();
  }
