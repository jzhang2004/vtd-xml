...
public class VTDNavHuge {
     ...
     * @exception com.ximpleware.NavExceptionHuge The exception if the underlying byte 
     * content contains various errors. Notice that we are being conservative in making little assumption on
     * the correctness of underlying byte content. This is because the VTD etc can be generated by another
     * machine from a load-balancer.
	 ...
	 * @return int
	 * @exception com.ximpleware.NavExceptionHuge The exception is thrown if the underlying byte 
	 * content contains various errors. Notice that we are being conservative in making little assumption on
...
/*	private int getCharResolved2() throws NavExceptionHuge {
	 ...
	 * @exception com.ximpleware.NavExceptionHuge The exception is signaled if the underlying byte 
	 * content contains various errors. Notice that we are being conservative in making little assumption on
	 ...
	 * @return boolean
	 * @param en java.lang.String
	 * @exception com.ximpleware.NavExceptionHuge If the underlying raw char representation has errors.
	 */
     ...
     * @param URL java.lang.String
     * @param ln java.lang.String
     * @exception com.ximpleware.NavExceptionHuge When there is any encoding conversion error or unknown entity.
	 ...
	 * @param s java.lang.String
	 * @exception com.ximpleware.NavExceptionHuge When if the underlying byte 
	 * content contains various errors. Notice that we are being conservative in making little assumption on
	 * the correctness of underlying byte content. This is because the VTD  can be generated by another
	 * machine such as a load-balancer.
	**/
	 ...
	 * @param l long
	 * @param s java.lang.String
	 * @exception com.ximpleware.NavExceptionHuge When the underlying byte 
	 * content contains various errors. Notice that we are being conservative in making little assumption on
	 * the correctness of underlying byte content. This is because the VTD  can be generated by another
	 * machine such as a load-balancer.
	 * 
     ...
     * @param URL
     *            java.lang.String
     * @exception com.ximpleware.NavExceptionHuge
	 ...
	 * @return boolean
	 * @param direction int
	 * @exception com.ximpleware.NavExceptionHuge  When direction value is illegal.
	 */
	 ...
	 * @param direction int
	 * @param en String     
	 * @exception com.ximpleware.NavExceptionHuge  When direction value is illegal. Or there are errors 
